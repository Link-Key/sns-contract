  ...
  <section class="wrapper">
    ...
    <div class="login-wrapper">
      <div class="text-center">
        <img src="@/assets/images/logo.webp" alt width="400px" />
      </div>
        ...
        <el-form v-model="accountForm" class="mar-t-30">
          ...
          <div class="mar-b-30 form-item form-item-code">
            ...
            <el-input
              ...
              clearable
            ></el-input>
            <router-link to="/forgotPassword" style="display: none"
              >忘记密码</router-link
            >
          </div>
          <div class="mar-b-15 text-center">
            <el-button
              @click="accountLoginHandle()"
    ...
    <!--首次登录系统需要修改密码-->
    <section v-if="editPasswordWrapper" class="form-wrapper">
      <div class="form-container" style="width: 390px">
        ...
        <div class="mar-t-30">
          <el-form
            ...
            label-position="left"
          >
            <el-form-item label="设置登录密码" prop="editPassword">
              <el-input
                v-model="editPasswordForm.editPassword"
                type="password"
                placeholder="请输入登录密码"
              ></el-input>
            </el-form-item>
            <el-form-item label="确认登录密码" prop="editPassword2">
              <el-input
                @keyup.enter.native="submitEditPasswordForm('editPasswordForm')"
  ...
  methods: {
    ...
    accountLoginHandle() {
      ...
      if (this.accountForm.account === "" || this.accountForm.password === "") {
        ...
        if (this.accountForm.account === "admin" && this.accountForm.password === "fet123456") {
          //登录成功
          this.$message({
            type: "success",
            message: "登录成功"
